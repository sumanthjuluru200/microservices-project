package com.java.accounts.controller;

import com.java.accounts.constants.AccountConstants;
import com.java.accounts.dto.CustomerDTO;
import com.java.accounts.dto.ErrorResponseDto;
import com.java.accounts.dto.ResponseDto;
...
@Tag(
        ...
        , description = "CRUD REST API'S for Accounts in Eazybank to CREATE, UPDATE, DELETE and FETCH account details"
)
@RestController
